            ...
            <main className={styles["main"]}>
                ...
                <section className={styles["grid"]}>
                    <article>
                        ...
                        <p>
                            Presets export ESLint flat config arrays and keep
                            the older `flat/*` aliases for compatibility.
                        </p>
                    </article>
                    <article>
                        <Heading as="h2">SchemaStore aware</Heading>
                        <p>
                            The validation rule can read `$schema`, explicit
                            rule options, and SchemaStore catalog entries.
                        </p>
                    </article>
                    <article>
                        <Heading as="h2">Multi-format validation</Heading>
                        <p>
                            JSON-family files, YAML, TOML, JavaScript exports,
                            and Vue custom blocks share the same validation
                            path.
                        </p>
                    </article>
                </section>
