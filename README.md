...
> Shoutout to [ota-meshi/eslint-plugin-json-schema-validator](https://github.com/ota-meshi/eslint-plugin-json-schema-validator), which this fork builds on. The original plugin did the hard work of proving the JSON Schema validation model for JSON-like files in ESLint.
